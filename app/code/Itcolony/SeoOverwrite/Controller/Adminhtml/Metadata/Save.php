    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $this->_eventManager->dispatch(
                'seooverwrite_metadata_prepare_save',
                ['deparment' => $model, 'request' => $this->getRequest()]
            );

            try {
                $model->save();
                $this->messageManager->addSuccess(__('Seo Meta Data saved'));
                ...
                $this->messageManager->addException($e, __('Something went wrong while saving the Meta Data'));
            }
